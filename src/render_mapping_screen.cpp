...
MappingScreenRenderer::MappingScreenRenderer()
    : m_nh_private{"~"}, m_synchronizer(MappingScreenSyncPolicy(10),
                                        m_subscriber_map, m_subscriber_laser) {
  ...
  m_synchronizer.registerCallback(
      boost::bind(&MappingScreenRenderer::synchronizedCallback, this, _1, _2));
...
void MappingScreenRenderer::synchronizedCallback(
